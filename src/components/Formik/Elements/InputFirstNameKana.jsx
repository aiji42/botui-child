...
const InputFirstNameKana = ({ field, form, ...props }) => {
  return (
    <InputWithIcon type="text" placeholder="タロウ" field={field} form={form} {...props}
      onBlur={(e) => {
...
InputFirstNameKana.propTypes = {
  field: PropTypes.shape(fieldPropTypes),
  form: PropTypes.shape(formPropTypes),
};

export default InputFirstNameKana;
